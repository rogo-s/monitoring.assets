...
<!-- Navbar Header -->
        ...
        <nav class="navbar navbar-header navbar-expand-lg" data-background-color="blue2">
            ...
            <div class="collapse" id="search-nav">
                ...
                <div class="input-group">
                    ...
                    <input type="text" placeholder="Search for details..." class="form-control" />
                </div>
                </form>
            </div>
            <div class="d-flex ">
    ...
    <script>
        ...
        const response = await fetch(`http://localhost:3000/users?name=${inputSearchUser.value}&role=admin`)
        ...
        data.map(async (user) => {
            ...
            avatarImg.src = `assets-samudera/assets/img/profile2.jpg`; 
