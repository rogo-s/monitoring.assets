           ...
           <!-- coloum chat -->
            <div class="nav-item dropdown hidden-caret">
                <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
                    <div class="avatar-sm">
                        <img src="../../assets/img/chat-icon.png" alt="..." class="avatar-img rounded-circle" />
                    </div>
                </a>
                  ...
                  <li>
                    <div class="user-box">
                      ...
                      <h4> <?=$_SESSION['auth_user']['username'];?></h4>
                        ...
                        <a href="./admin/admin-profile.php" class="btn btn-xs btn-secondary btn-sm">View Profile</a>
                      </div>
                    </div>
                  </li>
                  <li>
