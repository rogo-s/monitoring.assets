...
<body>
    ...
    <div class="main-panel">
      <div class="content">
        <div class="page-inner">
          ...
          <div class="row">
            <div class="col-md-12">
              <form id="submit-check" action="proses-add.php" method="POST" enctype="multipart/form-data">
                <div class="card">
                    ...
                    <div class="row">
                      <div class="col-md-6 col-lg-4">
                        <div class="form-group">
                          ...
                          echo '<input type="number" class="form-control" name="nik" placeholder="NIK" required/>';
                          ?>
                        </div>
                        <div class="form-group">
                          <?php
                          echo '<label for="staff_name">Staff Name</label>';
                          echo '<input type="text" class="form-control" name="staff_name" placeholder="Staff Name" required/>';
                          ?>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6 col-lg-4">
                        ...
                        <div class="form-check">
                          ...
                          <label class="form-radio-label">
                            <input class="form-radio-input" type="radio" name="gender" value="M" />
                      ...
                      <div class="col-md-6 col-lg-4">
                        <div class="form-group">
                          ...
                          echo '<select class="form-control" name="branch" required>';
                  ...
                  <div class="card-action">
                    <input type="hidden" name="submit-chck">
                    <button type="submit" class="btn btn-success" name="add_staff">Add User</button>
  ...
  <script src="https://cdn.jsdelivr.net/npm/axios/dist/axios.min.js"></script>
    <script>
      ...
      document.querySelector('button[name="add_staff"]').addEventListener('click', function(e) {
