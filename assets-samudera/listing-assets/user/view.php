...
if (isset($_GET['id'])) {
    ...
    while ($row = mysqli_fetch_array($query)) {
      ...
      <p style="text-align: center;">&nbsp;<strong>BERITA ACARA SERAH TERIMA BARANG</strong></p>
      <p style="text-align: justify;">Pada hari ini, ' . $today . ' yang bertanda tangan di bawah ini :</p>
      <p style="text-align: left;">Nama&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; : '  . $exOwner . '</p>
      <p style="text-align: left;">NIK&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: '  . $row['nik_firstuser'] . '</p>
      <p style="text-align: left;">Perusahaan&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: PT. Masaji Tatanan Kontainer Indonesia</p>
      <p style="text-align: left;">Selanjutnya di sebut dengan <strong>PIHAK PERTAMA</strong></p>
      <p style="text-align: left;">Nama&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; : '  . $row['staff_name'] . '</p>
      <p style="text-align: left;">NIK&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: '  . $row['nik'] . '</p>
      <p style="text-align: left;">Perusahaan&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: PT. Masaji Tatanan Kontainer Indonesia</p>
      <p style="text-align: left;">Selanjutnya di sebut dengan <strong>PIHAK KEDUA</strong></p>
      <p style="text-align: left;"><strong>PIHAK PERTAMA </strong>menyerahkan barang kepada <strong>PIHAK KEDUA</strong> dan <strong>PIHAK KEDUA </strong>menyatakan telah menerima barang dari <strong>PIHAK PERTAMA</strong>, berupa daftar terlampir :</p>
      ...
      <p style="text-align: justify;">Demikian berita acara serah terima barang ini di buat oleh kedua belah pihak. Adapun barang barang tersebut dalam keadaan baru dan baik. Sejak penanda tanganan berita acara ini, maka barang tersebut menjadi tanggung jawab <strong>PIHAK KEDUA</strong>, untuk memelihara dan merawat dengan baik serta di pergunakan untuk keperluan perusahaan PT. Masaji Tatanan Kontainer Indonesia.</p>
      
      <table style="height: 50px; width: 428px;" border="1">
      <tbody>
      <tr style="height: 19px;">
      <td style="width: 249.583px; height: 19px; text-align: center;"><strong>PIHAK PERTAMA</strong></td>
      <td style="width: 246.417px; height: 19px; text-align: center;"><strong>PIHAK KEDUA</strong></td>
      </tr>
