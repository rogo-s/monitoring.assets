...
?>
    ...
    <head>
        ...
        <title>Samudera - Edit Assets Non User</title>
    ...
    <body>
        <div class="wrapper sidebar_minimize">
                                ...
                                <form action="proses-edit.php?id=<?php echo $id; ?>" method="POST" enctype="multipart/form-data">
                                    <div class="card">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-lg-4">
                                                    ...
                                                    ?>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="status_device" id="options" onchange="toggleForm()">
                                                ...
                                                <div class="col-md-6 col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="serial_number" placeholder="Serial Number" value="<?php echo $sn; ?>" />
                                                    </div>

                                                    <div class="form-group">
                                                        <label for="internetProtocol">Internet Protocol</label>
                                                        <input type="text" class="form-control" name="ip" placeholder="Internet Protocol" value="<?php echo $ip; ?>" />
                                                    </div>
                                                ...
                                                <div class="col-md-6 col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="loc" placeholder="Location" value="<?php echo $loc; ?>" />
                                                    </div>
                                        ...
                                        <div class="card-action">
                                            <button type="submit" class="btn btn-success" name="update_device_non">Update Device </button>
                                            <a href="./detail-non.php?id=<?php echo $id; ?>">
            ...
            <script>
                document.querySelector('button[name="update_device_non"]').addEventListener('click', function() {
