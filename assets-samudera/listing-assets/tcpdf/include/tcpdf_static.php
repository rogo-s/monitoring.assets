...
class TCPDF_STATIC
{
	...
	{
		// Check if the file path is already prefixed with 'file://'
		...
		// Remove duplicated server root path, if any
		$filename = str_replace('file:///var/www/html/', '/var/www/html/', $filename);
		// $filename = str_replace('file:///var/www/html/', 'https://sslog.apps.samudera.id:9500/', $filename);
		// echo $filename . " - " . $mode;
